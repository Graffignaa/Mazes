...
class Maze extends World {
    ...
    final static int WINDOW_WIDTH = 1500; // Width of the animation window
    final static int WINDOW_HEIGHT = 900; // Height of the animation window
...
class ExamplesMazes {
    ...
    void testDrawIt(Tester t) {
        ...
        mainMaze.bigBang(Maze.WINDOW_WIDTH * 6 / 5, Maze.WINDOW_HEIGHT, 0.005);
